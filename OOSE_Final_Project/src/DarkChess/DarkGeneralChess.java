...
public class DarkGeneralChess extends AbstractGeneral {
    ...
    public DarkGeneralChess(int x, int y, int priority, boolean Group, MoveStrategy moveStrategy, EatStrategy eatStrategy) {
