...
import Framework.AbstractSoldier;
import Framework.EatStrategy;
import Framework.MoveStrategy;

public class ChineseSoldierChess extends AbstractSoldier {
  ...
  public ChineseSoldierChess(int x, int y, int priority, boolean Group, boolean status, MoveStrategy moveStrategy, EatStrategy eatStrategy) {
